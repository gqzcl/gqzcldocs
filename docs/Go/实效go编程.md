[文档](https://go-zh.org/doc/) [包](https://go-zh.org/pkg/) [项目](https://go-zh.org/project/) [帮助](https://go-zh.org/help/) [博客](https://go-zh.org/blog/) [运行](http://play.golang.org/) 
...
除[特别注明](http://code.google.com/policies.html#restrictions)外， 本页内容均采用知识共享-署名（CC-BY）3.0协议授权，代码采用[BSD协议](https://go-zh.org/LICENSE)授权。
[服务条款](https://go-zh.org/doc/tos.html) | [隐私政策](http://www.google.com/intl/en/policies/privacy/)