...
[实现如下：](https://github.com/lifei6671/interview-go/blob/master/src/q010.go)
type Map struct {
	c  map[string]*entry
	rmx *sync.RWMutex
}
 ...
 **golang** **并发题目测试**
题目来源： [Go](https://colobu.com/2019/04/28/go-concurrency-quizzes/)[并发编程小测验： 你能答对几道题？](https://colobu.com/2019/04/28/go-concurrency-quizzes/)
...
**Redis****中的数据结构**
原文地址 [Redis](https://www.cnblogs.com/neooelric/p/9621736.html)[中的数据结构](https://www.cnblogs.com/neooelric/p/9621736.html)
...
SDS的总体概览如下图:
![img](file:///tmp/lu22634rod61c.tmp/lu22634rod63i_tmp_6d36d65a3cf2db9a.png)
